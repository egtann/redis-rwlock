...
func (l *lockerImpl) Read(ctx context.Context, fn func()) error {
	return l.do(ctx, fn, l.acquireReader, l.refreshReader,
		l.releaseReader)
}
...
func (l *lockerImpl) execute(
	...
	for i := 0; i < attempts; i++ {
		if ok, err := fn(ctx); err != nil {
			...
			return true, nil
		} else if err := l.wait(ctx, l.options.RetryInterval); err != nil {
			return false, err
		}
	}
	return false, nil
...
func (l *lockerImpl) keepRefreshing(
	ctx context.Context,
	refresh func(context.Context) (bool, error),
	stop chan struct{},
) {
